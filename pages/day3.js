...
Course of Action Taken/Investigation: The General Manager, citing specific departmental rules and the CCS (CCA) Rules, issues a charge sheet under Rule 14 (the procedure for major penalties) against the officer. The charge sheet is comprehensive, detailing the allegations, the evidence, and the articles of charge. The officer immediately challenges this action, arguing that a General Manager, who cannot impose a major penalty, also lacks the authority to initiate a proceeding for one. The officer claims the entire disciplinary proceeding is void ab initio (void from the beginning) because the charge sheet was issued by an authority not competent to impose the penalty sought.
Proves that Came Out: The General Manager's action of initiating the disciplinary proceedings was challenged in court. The court upheld that an inquiry under Rule 14, leading to a major penalty, must be initiated by an authority competent to impose that penalty. Since the General Manager could only impose minor penalties, the court ruled that the entire disciplinary proceeding initiated by him was fundamentally flawed, even though he was the immediate superior.
`,
    question: `Citing the relevant **CCS (CCA) Rule**, explain whether the General Manager, not being the authority competent to impose a major penalty, was legally authorized to issue the charge sheet for a major penalty proceeding. What precedent or legal principle governs this situation?`,
}
